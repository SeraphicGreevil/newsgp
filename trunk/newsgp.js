...
var newsgp = {
    ...
    loaders: {
        popup: {
            refCounter: 0,
            element: $('<div class="popup"><p class="popup__heading"></p><center><div><i class="fa fa-refresh fa-spin fa-5x"></i></div></center></div>').appendTo("body"),
            popup: null,
            show: function () {
        ...
        inline: {
            refCounter: 0,
            element: $('<div style="min-height: 40px; --webkit-vertical-align: middle;"><center><div style="display: inline-block;"><i class="fa fa-refresh fa-spin fa-5x"></i></div></center></div>').insertAfter(".pagination:first"),
            show: function () {
                if (this.refCounter == 0) {
                    this.element.show();
                }
